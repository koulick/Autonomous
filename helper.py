...
def dirsearch():
    result=subprocess.run("git clone https://github.com/maurosoria/dirsearch.git ;cd dirsearch; pip install -r requirements.txt", shell= True, stdout=subprocess.DEVNULL, stderr=subprocess.STDOUT)
    ...
    # os.system("sudo apt remove dirsearch")
